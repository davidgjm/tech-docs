...
|Design Principles
|xref:software-design/design-principles/README.adoc[Design Principles]
|design principles for Azure apps and other types of applications
...
|xref:security/oidc-oauth2/README.adoc[OIDC & OAuth2]
|OpenIDConnect & OAUTH2

|Authentication
|xref:security/sasl/README.adoc[SASL]
|
