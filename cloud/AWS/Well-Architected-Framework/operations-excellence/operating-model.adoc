...
image::ops-model_01.png[width=300]
image:ops-model_02.png[width=300]
image:ops-model_03.png[width=300]
image:ops-model_04.png[width=300]
image:ops-model_05.png[width=300]
